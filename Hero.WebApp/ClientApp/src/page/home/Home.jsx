...
export class Home extends Component {
  ...
  searchProduct = (e) => {
    ...
    productApiService.search(this.state.keyword)
    .then(response => {
      this.setState({
        isSearching: false,
    ...
    return (
      <div id="home">
        ...
        <section id="search-result">
            <Row>
              {this.state.searchResult !== null && this.state.searchResult.map((item, index) => 
              <Col key={index} md="4"><ProductCard item={item} /></Col>
              )}
          </Row>
            </section>
      </div>
